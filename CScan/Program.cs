...
namespace CScan
{
    ...
    class Program
    {
        ...
        static void Help()
        {
            ...
            Console.WriteLine(exepath + " 192.168.1.0/24 21-23,25,80,443\n");
            Console.WriteLine(exepath + " 192.168.1.0/24 top100\n");
            Console.WriteLine(exepath + " 192.168.1.0/24 top1000\n\n");
            Console.WriteLine("Just Scan Ports that can lead to RCE (subjective)");
            Console.WriteLine(exepath + " 192.168.1.110 rce\n");
        ...
        public static string[] Nmap(string ports)
        {
            if (ports == "top100")
            {
                //string[] portlist = {"22","445","3389"};
                string[] portlist = { "7", "9", "13", "21-23", "25-26", "37", "53", "79-81", "88", "106", "110-111", "113", "119", "135", "139", "143-144", "179", "199", "389", "427", "443-445", "465", "513-515", "543-544", "548", "554", "587", "631", "646", "873", "990", "993", "995", "1025-1029", "1110", "1433", "1720", "1723", "1755", "1900", "2000-2001", "2049", "2121", "2717", "3000", "3128", "3306", "3389", "3986", "4899", "5000", "5009", "5051", "5060", "5101", "5190", "5357", "5432", "5631", "5666", "5800", "5900", "6000-6001", "6646", "7070", "8000", "8008-8009", "8080-8081", "8443", "8888", "9100", "9999-10000", "32768", "49152-49157" };
                return portlist;
            }
            if (ports == "top1000")
            {
            ...
            if (ports == "rce")
            {
                string[] portlist = { "21", "22", "23", "389", "5432", "3306", "1433", "1434", "139", "445", "3389", "389", "8500", "5985", "80", "443", "8080", "8443", "81-83", "9443", "9090", "8181", "636", "2049", "3390", "33389", "2222", "6379", "27017" };
                return portlist;
            }
            if (ports != "top1000" && ports != "top100")
            {
                Console.WriteLine("Error Specifying Ports, see below\n");
                Program.Help();
                string[] portlist = { "Error"};
                return portlist;
            }

            Console.WriteLine("Port Error");
            string[] porterror = {"Error"};
            return porterror;
        }
        ...
        static void Main(string[] args)
        {
            ...
            if (args[0].Contains("/"))
            {
                ...
                string[] portarray = Program.Nmap(args[1]);
                if (portarray[0] == "Error")
                {
                    System.Environment.Exit(1);
                }
                else
                {
                    ...
                    foreach (string singleport in portarray)
                    {
                        ...
                        {
                            var portRange = singleport.Split('-');
                            Int32 start = Int32.Parse(portRange[0]);
                            Int32 end = Int32.Parse(portRange[1]);
                            Int32 currport = start;
                            while (start <= end)
                            {
                                Program.ReturnCIDR(ipcidr[0], ipcidr[1], currport.ToString());
                                currport++;
                            }
                        }
                        else
                ...
                else
                {
                    ...
                    foreach (string singleport in portarray)
                    {
                        if (singleport.Contains("-"))
                        {
                            ...
                            while (currport <= end)
                            {
                                Program.scan(args[0], currport.ToString());
                                currport++;
                            }
                        }
                        else
